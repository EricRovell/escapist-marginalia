...
export class Boid {
	...
	constructor({ forceLimit = 0.05, mass = 1, scale = 5, separation, speedLimit = 1.5, x, y }: Partial<BoidOptions> & Pick<BoidOptions, "separation" | "x" | "y">) {
	...
	applyBehaviors(boids: Boid[], coef: BehaviorCoef): void {
		let count = 0;
